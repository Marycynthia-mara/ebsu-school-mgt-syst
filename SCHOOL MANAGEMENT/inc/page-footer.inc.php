<!--footer-->
	<div class="contact-footer-w3layouts-agile">
		...
		<div class="copy-w3-agileits">
			<h2 class="footer-logo"><a href="index">EBSU <span>Staff Secondary School</span></a></h2>
			<p>© 2019 <?php if (intval(date('Y')) > 2019) {
				echo  " - " . date('Y');
			} ?> EBSU . All Rights Reserved | Design by <a href="tel:+2349063399674">Marycynhia Amarachi Ugwu</a></p>
			<div class="clearfix"></div>
		</div>
	</div>
	<!--/footer -->
