<?php 
$pageTitle = "Manage Teacher Search";
...
if (isset($_POST['Search'])) {
  $result = fetch_search_result2($_POST);
 ...
 ?>
  ...
  <div>    Search
    <div style="float: right;" id="example_filter" class="search-box">
        ...
        <button class="btn btn-primary"  type="submit" name=""><i class="fa fa-search"></i></button>
    </div>
  </div>
  </form>
  </div>
                        ...
                        <?php }} elseif(count($result) == count($result, COUNT_RECURSIVE)){ 
                          ...
                          ?>
                            ...
                            <tr>
                              <td><?php echo ++$counter; ?></td>
                              <!-- <td><input style="width: 20%; float: left;" class="form-control" type="checkbox" name="studdent[]" value="<?php   ?>"></td> -->
                              <td><a href="profile.php?user_id=<?php echo $teachers_id; ?>"><?php echo ucfirst($firstname) .' '. ucfirst($lastname) .' '. ucfirst($surname);?></a></td>
                              <td><a href="profile.php?user_id=<?php echo $teachers_id; ?>"><?php echo $username; ?></a></td>
                              <td><?php echo $gender; ?></td>
                              <td><?php echo $phone; ?></td>
                              <td> <?php  if ($form_class == "NONE") {
                                echo "NONE";
