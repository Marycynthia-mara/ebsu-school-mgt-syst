  ...
  <table>
    ...
    <table> 
      <tr> 
        ...
        <td style="border:none; border-bottom: 1px solid #000; width: 20em;"><input type="text" value="<?php if($tea_comt){
...
<div class="special_action_confirm"><div id="content1" class="popup-effect"><div class="popup"><div class="letter-w3ls"><form method="post"><h1 class="ebsu">EBSU STAFF SECONDARY SCHOOL ABAKALIKI.</h1><section><p>Are you sure you want to Upload Comment?</p></section><div class="btnn"><button type="submit" name="submit">Proceed</button> <button class="">Cancel</button><br></div></form></div></div></div></div>
...
<?php if ( isset($msg
  ...
  <script>
    ...
    setTimeout(function refresh(){
		window.location = 'stud_result_annual_sheet_p_comm.php?stud_id=<?php echo $stud_id?>';
	}, 1000);
