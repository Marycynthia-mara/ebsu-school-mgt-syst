<?php 
$pageTitle = "Manage Student Search";
...
if (isset($_POST['Search'])) {
  $result = fetch_search_result($_POST);
                            ...
                            <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <?php }} elseif(count($result) == count($result, COUNT_RECURSIVE)){ 
                                    ...
                                    <tr>
                                        <td><?php echo ++$counter; ?></td>
                                        <!-- <td><input style="width: 20%; float: left;" class="form-control" type="checkbox" name="studdent[]" value="<?php   ?>"></td> -->
                                        <td><a href="profile.php?user_id=<?php echo $student_id; ?>"><?php echo ucfirst($firstname) .' '. ucfirst($lastname) .' '. ucfirst($surname);?></a></td>
                                        <td><a href="profile.php?user_id=<?php echo $student_id; ?>"><?php echo $reg_no ?></a></td>
                                        <?php $classes = fetch_class($class, 'classroom'); ?>
                                        <td><?php foreach ($classes as $class):
                                            echo $classes['classroom_name'];
                                            break;
