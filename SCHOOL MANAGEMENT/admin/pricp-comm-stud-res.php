                    ...
                    <div class="panel-body p-20">
                        ...
                        <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            if ($_SESSION['exam_term_comt'] === "first" or $_SESSION['exam_term_comt'] === "second") {
                                ...
                                if ($results === false) {
                                echo"<script>alert('students in this class don\'t yet have result')</script>";
                                redirect_to('principals_comment.php');
                                }
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    stud_result_sheet_p_comm.php?stud_id=<?php echo $each_Stud['student_id']; ?>
                                    <?php endif ?>

                                    <?php if($_SESSION['exam_term'] === 'third'): ?>
                                    stud_result_annual_sheet_p_comm.php?stud_id=<?php echo $each_Stud['student_id']; ?>
