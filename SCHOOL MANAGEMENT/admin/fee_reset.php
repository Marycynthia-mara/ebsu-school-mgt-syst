<?php 
$pageTitle = "Update Class School Fees Payment Status";
      ...
      // $errors = $result;
              ...
              if (isset($_POST['UpdClass'])) {
                 if (isset($_POST['fee_status'])) {
                  extract($_POST);
                  $result = update_table('students', 'fees_paid' , $fee_status, 'class', $_SESSION['class_id']);
                  if ($result === true) {
                   $UpdMsg = true;
                  }else{
...
<form method="post" id="updateClass" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
          ...
          <div class="col-lg-6" style="margin: 20px auto">
            <div class="section-wrapper">
              <label class="section-title">RESET STUDENT  SCHOOL FEES STATUS</label>
              ...
              <?php if (isset($fetchClassMsg) ): ?>
                ...
                <P>NB: By clicking Reset sets the status of all the students to true or false, indicating that all of them have paid their fees or none have paid their fees for that term.</P>
                <div class="row">
               ...
               <div class="row">
                 <label class="col-sm-4 form-control-label">School Fee confirmation status: <span class="tx-danger">*</span></label>
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <div class="form-group has-warning mg-b-0">
                      <select class="form-control"  name="fee_status" style="margin-bottom: 10px;">
                        <option disabled="" selected="">Choose...</option>
                        <option value="true">Activate All</option>
                        <option value="false">Dectivate All</option>
                    ...
                    <div class="alert alert-danger mg-b-0" role="alert">
                      ...
                      <strong>Oh snap!</strong> Select a status for this class.
                    </div><!-- alert -->
              ...
              <div class="special_action_confirm"><div id="content1" class="popup-effect"><div class="popup"><div class="letter-w3ls"><form method="post"><h1 class="ebsu">EBSU STAFF SECONDARY SCHOOL ABAKALIKI.</h1><section><p>Are you sure you want to Reset?</p></section><div class="btnn"><button class="btn btn-primary bd-0" name="UpdClass" >proceed</button><button class="btn btn-primary bd-0">Cancel</button><br></div></form></div></div></div></div>
               ...
               <?php if (isset($errors['fee_status_error'])): ?>
                    ...
                    <div class="alert alert-danger mg-b-0" role="alert">
                      ...
                      <strong>Likly Reasons</strong> Class already possess the selected status,
                    </div><!-- alert -->
