            ...
            <div class="row no-gutters">
               ...
               <div class="col-md-4 <?php if (isset($errors['class'])) {
                  ...
                  <div class="form-group mg-md-l--1 bd-t-0-force">
                    ...
                    <?php $form_class = fetch_column5('form_class', 'teachers', 'teachers_id', $_SESSION['user_id']);
                    extract($form_class);
                    ...
                    <select id="select2-a" class="form-control " name="class" data-placeholder="Select Class">
                          ...
                          <?php 
                              $counter = 0;
                              foreach ($form_classes as $form_cls)  { ?>
                              <?php   $curr_form_cls = fetch_class($form_classes[$counter], 'classroom') ;
                                extract($classroom);
                              ?>
                                  <option   class=""  value="<?php echo $curr_form_cls['classroom_id'] ?>"><?php echo ucwords($curr_form_cls['classroom_name']) .' '. $curr_form_cls['academic_year'];  ?></option>
                            <?php 
                              $counter++;
                          } ?>  
  
                          <!-- <?php   $classroom = fetch_class($form_class, 'classroom'); ?> -->
                            <!-- <option   class=""  value="<?php echo $form_class ?>"><?php echo $classroom['classroom_name'] .' '. $classroom['academic_year'];  ?></option> -->
