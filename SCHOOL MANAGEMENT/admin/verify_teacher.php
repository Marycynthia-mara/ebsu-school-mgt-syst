...
?>
 ...
 <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
    ...
    <div class="section-wrapper" style="margin: 20px 0">
        <label class="section-title">Verify Teacher</label>
        <p class="mg-b-20 mg-sm-b-40">Verify Teacher's account here.</p>
        ...
        <?php }else{?>
            ...
            foreach($results as $result):
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-demo">
                            <button class="btn btn-primary btn-sm mg-b-10" type="submit" name="verify<?php echo $counter ?>" style="margin-bottom:0;">Verify</button>
                        </div>
                    </td>
                </tr>
