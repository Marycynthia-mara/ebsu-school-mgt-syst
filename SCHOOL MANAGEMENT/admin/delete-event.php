      ...
      // $errors = $result;
              ...
              if (isset($_POST['UpdEvent'])) {
                 if (isset($_POST['title']) and isset($_POST['body'])) {
                  $result = delete_table('events', 'event_id', $_SESSION['event_id']);
                  if ($result === true) {
                   $UpdMsg = true;
                  }else{
                    $errors['UEvent'] = true;
...
<form method="post" id="updateClass" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data">
            ...
            <div class="section-wrapper">
              ...
              <div class="row">
                 <label class="col-sm-4 form-control-label">Select Event: <span class="tx-danger">*</span></label>
                  ...
                  <div class="alert alert-danger mg-b-0" role="alert">
                      ...
                      <strong>Oh snap!</strong> Something went wrong, ensure you choose an event to delete.
                    </div><!-- alert -->
              ...
              <?php if (isset($fetchEventMsg) ): ?>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <input type="text" readonly="" class="form-control" name="title"  value="<?php echo $fetched_event['event_title'] ?>" style="margin-bottom: 10px;">
                  </div>
                </div><!-- row -->

                <div class="" style="margin-bottom: 20px;">
                  <div class="form-group has-success mg-b-0">
                    <textarea readonly="" rows="3" class="form-control is-valid mg-t-20" name="body" placeholder="Event body" ><?php echo $fetched_event['event_desc'] ?></textarea>
                  </div><!-- form-group -->
                </div>
              ...
              <div class="row">
               ...
               <div class="form-layout-footer mg-t-30">
                  <a class="btn btn-primary bd-0" href="#content1">Delete Event</a>
                </div><!-- form-layout-footer -->

                <div class="special_action_confirm"><div id="content1" class="popup-effect"><div class="popup"><div class="letter-w3ls"><form method="post"><h1 class="ebsu">EBSU STAFF SECONDARY SCHOOL ABAKALIKI.</h1><section><p>Are you sure you want to Delete Event?</p></section><div class="btnn"><button class="btn btn-primary bd-0" name="UpdEvent">Proceed</button><button class="btn btn-primary bd-0">Cancel</button><br></div></form></div></div></div></div>
               ...
               <?php if (isset($errors['UEvent1'])): ?>
                  ...
                  <?php if (isset($errors['UEvent'] )): ?>
                    ...
                    <div class="alert alert-danger mg-b-0" role="alert">
                      ...
                      <strong>Oh snap!</strong> Delete not sucessful.
                    </div>
                    <!-- alert -->
          ...
          <div class="alert alert-success" role="alert">
            ...
            <strong>Well done!</strong> Event successfully Deleted.
          </div><!-- alert -->
